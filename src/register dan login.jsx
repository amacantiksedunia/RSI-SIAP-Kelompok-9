...
<head>
    ...
    <title>Login & Registrasi - Sewa Alat Pendakian</title>
...
<body class="bg-gray-50">
            ...
            <div class="w-full md:w-1/2 p-8 md:p-12">
                ...
                <div id="login-form">
                    ...
                    <p class="text-center text-sm text-gray-600 mt-6">
                        Belum punya akun? <a href="#" id="show-register" class="font-semibold text-brand-blue hover:underline">Daftar di sini</a>
                    </p>
                </div>
                ...
                <div id="register-form" class="hidden">
                    ...
                    <p class="text-center text-sm text-gray-600 mt-6">
                        Sudah punya akun? <a href="#" id="show-login" class="font-semibold text-brand-blue hover:underline">Masuk di sini</a>
                    </p>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Navigasi antara form login dan register
            ...
            loginFormElement.addEventListener('submit', function(e) {
                ...
                // Di sini Anda akan menggantinya dengan fetch() ke backend Anda
            ...
            registerFormElement.addEventListener('submit', function(e) {
                ...
                // Simulasi respons API
                showAlert('Registrasi berhasil! Silakan masuk.', true);
                setTimeout(() => {
